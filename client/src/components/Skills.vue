<template>
  <v-row>
    ...
    <v-col order="1" order-md="1" cols="4" offset="4" md="3" lg="2" offset-md="1" offset-lg="3">
      <BlobImage>
        <image href="@/assets/images/js.png" height="200" width="100%"/>
      </BlobImage>
    </v-col>
    ...
    <v-col order="3" order-md="4" cols="4" offset="4" md="3" lg="2" offset-md="0" offset-lg="0">
      <BlobImage>
        <image href="@/assets/images/language.png" height="200" width="100%"/>
      </BlobImage>
    </v-col>

    <v-col order="5" order-md="5" cols="4" offset="4" md="3" lg="2" offset-md="1" offset-lg="3">
      <BlobImage>
        <image href="@/assets/images/db.png" height="200" width="95%"/>
      </BlobImage>
    </v-col>
    ...
    <v-col order="7" order-md="8" cols="4" offset="4" md="3" lg="2" offset-md="0" offset-lg="0">
      <BlobImage>
        <image href="@/assets/images/computer.png" height="200" width="95%"/>
      </BlobImage>
    </v-col>
  </v-row>
</template>
